# Team Assemble Server Service (Vercel)

This folder contains a minimal Vercel-hosted server service for Slack previews and planner CSV export.
...
Then the app's "Copy Slack share" buttons will copy a Vercel `/share` link.
Planner CSV export (`export=true`) will also use this same Vercel deployment when `VITE_SERVER_BASE_URL` is configured.

## Example link

```text
https://your-server-service.vercel.app/share?team=86e569a9-18f3-4c05-b4ec-f026741ed93f&app=https%3A%2F%2Fchristian-crisologo-lrn.github.io%2Fteam-assemble
```

CSV export endpoint example:

```text
https://your-server-service.vercel.app/planner-csv?team=86e569a9-18f3-4c05-b4ec-f026741ed93f&filter=start_date=2026-08-01,status=completed|active
```
